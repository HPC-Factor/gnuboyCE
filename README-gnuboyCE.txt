...
This is a Game Boy emulator for Windows CE.  It is a port of the
GPL'ed gnuboy software to the Windows CE platform.  The current
version supports iPAQ only.
...
4. Place your GB/GBC ROM image files in \My Documents\gnuboy.
